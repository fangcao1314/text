package com.caozhi.videoplayer.main;
...
import com.caozhi.videoplayer.views.MainWindow;
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					frame.getMediaPlayer().prepareMedia("E:\\transformers.age.of.extinction.2014.1080p.bluray.x264-sparks.mkv",options);
